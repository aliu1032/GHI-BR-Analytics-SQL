Select
	...
	/* HCP Submitted Clinical Criteria on an OLI */
		...
		, dimClinicalCriteria.IBC_NodalStatusDescription NodalStatus
		...
		, Case 
		  ...
		  when dimTest.TestName = 'Prostate' then dimClinicalCriteria.Prostate_ClinicalStageDescription
	...
	/* Test result from GHI lab */
		...
		, dimCategoricalLabResult.EstimatedNCCNRiskDescription EstimatedNCCNRisk
...
where 
 ...
 -- and fctOLI.OrderLineItemID in ('OL000932516')
