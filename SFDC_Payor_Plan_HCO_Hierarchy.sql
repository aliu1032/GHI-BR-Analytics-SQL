...
select  
		...
		HCO.OSM_Status__c Tier4_Status, '' as QDX_Ins_Plan_Code, RecType.Name FinancialCategory, HCO.Type LineOfBenefit,
...
select
	   Case
		...
		PP.QDX_Ins_Plan_Code, PP.FinancialCategory, PP.LineOfBenefit,
--		A.ParentId,
...
from (
	   ...
	   select P.OSM_Payor__c, P.Id Tier4_SysId, P.Name Tier4Payor, P.OSM_Plan_ID__c Tier4PayorID, P.OSM_QDX_Insurance_Plan_Code__c QDX_Ins_Plan_Code, P. OSM_Payor_Hierarchy__c
	 		, RecType.Name LineOfBenefit , P.OSM_QDX_Financial_Category__c FinancialCategory
